        ...
        <Flex>
          <Box w="50%" h="100vh" bg="nida.green">
            ...
            <VStack w="70%" float="right" 
                    ...
                    spacing="40px" >
              <Text color="nida.white" fontSize="30px" lineHeight={1} fontWeight="bold">Hi, I'm</Text>
              <Text color="nida.white" fontSize="80px" lineHeight={1}>Ni'mal Mursyidah</Text>
              <Text color="nida.white">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ratione, id velit vitae, dolorum, aut dolor ullam perferendis rem tenetur hic maiores accusantium quaerat nobis soluta numquam libero impedit. Pariatur, necessitatibus.</Text>
            </VStack>
          </Box>
